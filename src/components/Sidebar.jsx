...
const Sidebar = () => {
  ...
  return (
     <div className="w-full flex flex-col justify-between h-screen w-[260px] border-r bg-white p-[20px] gap-[20px]">
      ...
      <div>
        ...
        <div className="bottom-border-sty">
        </div>
      </div>
      ...
      <div className="bg-[#F2F2F2] p-[12px] rounded-[12px] flex items-center gap-[10px] shadow-sm mt-5">
        ...
        <span className="text-[14px] font-[400] text-[#404040] LEADING-[18PX]">Nancy</span>
      </div>
    </div>
    // <div>
