...
const Signup = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center mt-[120px] md:mt-[60px]">
        <div className="flex justify-end login_main">
          <button className="flex items-center gap-[4px] bg-[#1E3A8A] shadow-sm text-[#FFFFFF] px-2 py-1 rounded-md text-xs font-semibold"
            onClick={navigateToHome}
          >
            <svg width="18" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13 8H2M2 8L6.05263 4M2 8L6.05263 12" stroke="#FFFFFF" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            Daily Advisor AI
          </button>
        </div>
        <div className="w-full p-[20px] bg-[#FFFFFF] flex items-center justify-center">
